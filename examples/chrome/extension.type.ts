...
interface ExtensionContentScriptsArray {
     ...
     */
    matches: [MatchPatternLocal, ...MatchPatternLocal[]]
    /**
     * Excludes pages that this content script would otherwise be injected into.
     */
    exclude_matches: MatchPatternLocal[]
    /**
...
interface ExtensionNaclModulesArray {
    /**
...
export interface Extension {
     ...
     */
    minimum_chrome_version: VersionStringLocal
    /**
     * One or more mappings from MIME types to the Native Client module that handles each type.
     */
    nacl_modules: [ExtensionNaclModulesArray, ...ExtensionNaclModulesArray[]]
    /**
     ...
     */
    optional_permissions: PermissionsLocal
    /**
    ...
    tts_engine: {
         ...
         */
        web_accessible_resources: [UriLocal, ...UriLocal[]]
...
export const Extension = {
    ...
    validate: new AjvValidator().compile<Extension>(extensionSchema),
...
type MatchPatternLocal = string

type UriLocal = string

type ScriptsLocal = [UriLocal, ...UriLocal[]]

type GlobPatternLocal = string

type MimeTypeLocal = string

type VersionStringLocal = string

type IconLocal = UriLocal
...
type PageLocal = UriLocal

interface CommandLocal {
    description: string
    suggested_key: {
 ...
 */
type ContentSecurityPolicyLocal = string

type PermissionsLocal = string[]
