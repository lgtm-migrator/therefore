...
export type Page = Uri

export const Page = {
    schema: pageSchema,
    validate:
        typeof pageSchema === 'function'
            ? pageSchema
            : (new AjvValidator().compile(pageSchema) as {
                  (o: unknown | Page): o is Page
                  errors?: null | Array<import('ajv').ErrorObject>
              }),
    is: (o: unknown | Page): o is Page => Page.validate(o) === true,
    assert: (o: unknown | Page): asserts o is Page => {
        if (!Page.validate(o)) {
            throw new AjvValidator.ValidationError(Page.validate.errors ?? [])
        }
    },
}

export type Scripts = [Uri, ...Uri[]]
...
export const Extension = {
    ...
    is: (o: unknown | Extension): o is Extension => Extension.validate(o) === true,
    assert: (o: unknown | Extension): asserts o is Extension => {
