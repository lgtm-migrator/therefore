...
import { valuesOf, omit, omitUndefined, all, entriesOf, evaluate } from '@zefiros-software/axioms'
...
export function isCombinedDefinition(
    ...
    return x !== undefined && 'properties' in x && !all(valuesOf(x), isThereforeExport)
}
